...
function Appointment() {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(
        "http://localhost:5000/api/v1//appo",
      ...
      toast.error(error.response.data.message) ||
        toast.error("you are not login in");
      console.log(error);
    }
  };
  ...
  return (
    <div>
      <div className="appo-top ">
        <div className="  p-3 mb-5 bg-body-tertiary rounded appo-form-div">
          <form onSubmit={submitHandler} className="appo-form">
            ...
            <div className="col-sm-10 m-auto p-2">
              ...
              >
                ...
                <option value="12:30-1:00">12:30-1:00 pm</option>
                <option value="2:00-2:30">2:00-2:30 pm</option>
                <option value="2:30-3:00">2:30-3:00 pm</option>
                <option value="3:00-3:30">3:00-3:30 pm</option>
                <option value="3:30-4:00">3:30-4:00 pm</option>
                <option value="4:00-4:30">4:00-4:30 pm</option>
                <option value="4:30-5:00">4:30-5:00 pm</option>
              </select>
            </div>
            ...
            <div className="text-center m-1">
              ...
              <div className="text-center">
                <p>or</p>
                <Link clasName="m-0" style={{ color: "#6743a8" }} to="/login">
                  Login
                </Link>
              </div>
            </div>
